...
describe('<NavigationMenu.Trigger /> Suspense Integration', () => {
  const { render } = createRenderer();

  it.skipIf(isJSDOM)(
    'should not throw "Maximum update depth exceeded" when Content has suspending child with outer Suspense',
    async () => {
